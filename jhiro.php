...
<head>
  ...
  <link rel="stylesheet" href="jhiro.css">
</head>
<body>
  ...
  <header class="hero">
    <div class="container">
      <img src="pfp.jpg.jpg" alt="Profile Photo" class="profile-pic">
      <h1>Jhiro Zablan</h1>
      <p class="tagline">Information Technology Student</p>
  ...
  <section id="education" class="section bg-light">
    <h2>Education</h2>
    <ul>
      <li><strong>Tarlac State University 
Bachelor of Science in Information Technology majoy in Web and Mobile Application (2025-2026)</li>
  ...
  <section id="experience" class="section bg-light">
    ...
    <p>
      •  Intern- 
Corazon C. Aquino HS (March 2022 - Aprill 2022) <br>
      •  COC LEVEL 1 AND 2 <br>
  

 <footer>
    <p>&copy; 2025 WMA-4C</p>
  </footer>
